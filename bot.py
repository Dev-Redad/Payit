...
def main():
    ...
    add_product_conv = ConversationHandler(
        entry_points=[CommandHandler("addproduct", add_product_start, filters=admin_filters)],
        states={ 
    ...
    broadcast_conv = ConversationHandler(
        ...
        states={
            GET_BROADCAST_MESSAGE: [MessageHandler(Filters.all & ~Filters.command, get_broadcast_message), CommandHandler('done', send_broadcast, filters=admin_filters)],
        ...
        fallbacks=[CommandHandler('cancel', cancel_conversation, filters=admin_filters)], conversation_timeout=300)
